...
GLuint texture3;
GLuint texture4; //texture of skybox face cubemap
GLuint textureT1;
GLuint textureT2;
...
// key for controlling the movement of space craft
...
void sendDataToOpenGL()
{
	...
	bool res3 = loadOBJ("object/ufo.obj", vertices3, uvs3, normals3);

	glBindVertexArray(vao[2]);  //VAO for ufo model
	...
	bool res4 = loadOBJ("object/ufo.obj", vertices4, uvs4, normals4);

	glBindVertexArray(vao[3]);  //VAO for ufo model
	...
	bool res5 = loadOBJ("object/planet.obj", vertices5, uvs5, normals5);
	...
	bool resP = loadOBJ("object/planet.obj", Pvertices, Puvs, Pnormals);
	...
	bool resR = loadOBJ("object/rock.obj", Rvertices, Ruvs, Rnormals);
